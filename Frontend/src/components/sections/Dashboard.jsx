...
const Dashboard = () => {
    ...
    const detoxMetrics = [
        ...
        { label: 'Muscle Memory Index', value: 'Low Density', icon: NeuralCore, trend: 'Improving' },
        { label: 'Syntax Retention', value: 'High', icon: EnergyZap, trend: 'Stable' },
    ];

    const phases = [
        { title: 'Neural Baseline', status: 'verified', day: 'D1-D05' },
        { title: 'Manual Reconstruction', status: 'active', day: 'D06-D15' },
        { title: 'Constraint Solving', status: 'locked', day: 'D16-D25' },
        { title: 'Cognitive Ascendance', status: 'locked', day: 'D26-D30' },
    ];
                ...
                >
                    <div className="flex-1">
                        ...
                        <p className="text-white/60 font-light text-lg max-w-md leading-relaxed">
                            Tracking your departure from AI dependency. Rebuilding technical autonomy through rigorous manual patterns.
                        </p>
                    </div>
                    ...
                    {phases.map((phase, i) => {
                        ...
                        return (
                            <motion.div
                                ...
                                className={`bg-black p-8 relative overflow-hidden group ${
                                    phase.status === 'active' && isSessionActive ? 'border-l-2 border-white' : ''
                                }`}
                            ...
                            >
                                ...
                                <div className="flex justify-between items-start mb-8">
                                    <span className={`text-xs font-bold tracking-widest ${
                                        phase.status === 'active' && isSessionActive ? 'text-white' : 'text-white/30'
                                        }`}>
                                        {phase.day}
                                    </span>
                                ...
                                <h4 className={`text-xl font-black mb-4 tracking-tight ${
                                    phase.status === 'active' && isSessionActive ? 'text-white' : 'text-white/40'
                                    }`}>
                                    {phase.title}
                                </h4>
