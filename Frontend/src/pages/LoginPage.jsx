                ...
                <div className="bg-black border border-white/10 p-12">
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                        ...
                        <div className="flex items-center justify-between text-sm">
                            <Link to="/forgot-password" className="text-white/60 hover:text-white font-light transition-colors">
                                Forgot password?
                            </Link>
                        </div>
                    ...
                    <div className="relative my-8">
                        ...
                        <div className="relative flex justify-center text-xs uppercase">
                            <span className="px-4 bg-black text-white/40 font-bold tracking-widest">Or</span>
                        </div>
                    </div>
                    ...
                    <div className="space-y-3">
                        <a
                            ...
                            className="w-full h-14 bg-white/[0.02] border border-white/10 text-white font-bold uppercase tracking-widest text-sm flex items-center justify-center gap-3 hover:bg-white/[0.04] hover:border-white/20 transition-all"
                        >
                    ...
                    <div className="mt-8 text-center">
                        <p className="text-white/60 font-light text-sm">
                            ...
                            <Link to="/register" className="text-white hover:text-white/80 font-bold transition-colors">
                                Register
                            </Link>
                        </p>
                    </div>
