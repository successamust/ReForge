...
const RegisterPage = () => {
    ...
    const { addNotification, login } = useContext(AppContext);
                ...
                <div className="bg-black border border-white/10 p-12">
                    <div className="mb-10">
                        ...
                        <p className="text-white/60 font-light text-lg">
                            Start your 30-day coding challenge journey
                        </p>
                    </div>
                    ...
                    <div className="mt-8 text-center">
                        <p className="text-white/60 font-light text-sm">
                            ...
                            <Link to="/login" className="text-white hover:text-white/80 font-bold transition-colors">
                                Sign In
                            </Link>
                        </p>
                    </div>
